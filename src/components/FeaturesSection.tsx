...
export function FeaturesSection() {
  return (
    <section className="container mx-auto px-4 py-20 md:max-w-3/5 flex flex-col items-center">
      <div className="text-center flex flex-col gap-30 space-y-16">
      ...
      <Button data-aos="fade-up" data-aos-offset="0" data-aos-duration="1500" className="mt-28 rounded-full hover:bg-gray-800 font-bold px-15 py-10 text-xl ">
        Join Waitlist
      </Button>
    </section>
  );
